...
public class etshtinkerEntityRenderers {
    ...
    static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(etshtinkerEntity.PLASMA_SLASH.get(), plasmaSlashRenderer::new);
        ...
        event.registerEntityRenderer(etshtinkerEntity.EXO_SLASH.get(), ExoSlashRenderer::new);
        if (BOTloaded){
