...
public class etshtinkerEntity {
    ...
    public static final RegistryObject<EntityType<CustomSonicBoomEntity>> sonic_boom = ENTITIES.register("sonic_boom", () -> EntityType.Builder.<CustomSonicBoomEntity>of(CustomSonicBoomEntity::new, MobCategory.MISC).sized(0.05F, 0.05F).setTrackingRange(4).setUpdateInterval(10).setCustomClientFactory((spawnEntity, world) -> new CustomSonicBoomEntity(etshtinkerEntity.sonic_boom.get(), world)).setShouldReceiveVelocityUpdates(true));
    public static final RegistryObject<EntityType<ShockWaveEntity>> shock_wave = ENTITIES.register("shock_wave", () -> EntityType.Builder.<ShockWaveEntity>of(ShockWaveEntity::new, MobCategory.MISC).sized(0.05F, 0.05F).setTrackingRange(4).setUpdateInterval(10).setCustomClientFactory((spawnEntity, world) -> new ShockWaveEntity(etshtinkerEntity.shock_wave.get(), world)).setShouldReceiveVelocityUpdates(true));
