...
public class etshtinkerHook {
    ...
    public static final ModuleHook<PlasmaExplosionCreateModifierHook> PLASMA_EXPLOSION_CREATE = ModifierHooks.register(etshtinker.getResourceLoc("plsm_explosion_create"), PlasmaExplosionCreateModifierHook.class, PlasmaExplosionCreateModifierHook.AllMerger::new, (tool, fluidStack, player, explosion,primary)-> explosion);
    ...
    public static final ModuleHook<FoilModifierHook> FOIL = ModifierHooks.register(etshtinker.getResourceLoc("foil"), FoilModifierHook.class, FoilModifierHook.AllMerger::new,  (tool, isFoil)-> isFoil);
}
