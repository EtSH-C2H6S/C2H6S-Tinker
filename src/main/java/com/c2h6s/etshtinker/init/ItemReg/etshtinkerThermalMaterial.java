...
public class etshtinkerThermalMaterial {
    ...
    public static final RegistryObject<Item> activated_chroma_plate = ITEMS.register("activated_chroma_plate",( ) -> new ActivatedChromaPlateItem(new Item.Properties().tab(etshtinkerTab.MATERIALS)));//活化彩钢板
    ...
    public static final RegistryObject<Item> nights_alloy = ITEMS.register("nights_alloy",( ) -> new NightsAlloyItem(new Item.Properties().tab(etshtinkerTab.MATERIALS)));
}
