...
public class trinityblessing extends etshmodifieriii implements ToolStatsModifierHook, ToolDamageModifierHook,DisplayNameModifierHook {
    ...
    public void addToolStats(IToolContext context, ModifierEntry modifier, ModifierStatsBuilder builder) {
        if (modifier.getLevel()!=3){
            ...
            ToolStats.VELOCITY.multiply(builder,Math.pow(1.33,modifier.getLevel()));
            ToolStats.MINING_SPEED.multiply(builder,Math.pow(1.33,modifier.getLevel()));
            ToolStats.ARMOR.multiply(builder,Math.pow(1.33,modifier.getLevel()));
            ToolStats.ARMOR_TOUGHNESS.multiply(builder,Math.pow(1.33,modifier.getLevel()));
            ToolStats.PROJECTILE_DAMAGE.multiply(builder,Math.pow(1.33,modifier.getLevel()));
