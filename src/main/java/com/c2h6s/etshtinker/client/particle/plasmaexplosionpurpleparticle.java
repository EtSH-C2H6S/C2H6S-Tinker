...
public class plasmaexplosionpurpleparticle extends TextureSheetParticle {
    ...
    public static class PlasmaexplosionpurpleParticleProvider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public PlasmaexplosionpurpleParticleProvider(SpriteSet spriteSet) {
    ...
    protected plasmaexplosionpurpleparticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
        this.spriteSet = spriteSet;
        this.setSize(1f, 1f);
        this.quadSize =1.3f;
